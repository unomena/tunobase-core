...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContentModel.meta_description'
        db.add_column(u'core_contentmodel', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContentModel.meta_keywords'
        db.add_column(u'core_contentmodel', 'meta_keywords',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_polymorphiccontentmodel', (
            ...
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphiccontentmodel_modified_content', null=True, to=orm['authentication.EndUser'], blank=True)),
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphiccontentmodel_created_content', null=True, to=orm['authentication.EndUser'], blank=True)),
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphiccontentmodel_related', null=True, to=orm['photologue.PhotoEffect'], blank=True)),
            ('image_name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('publish_at', self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, db_index=True)),
        ...
        # Deleting field 'ContentModel.meta_description'
        db.delete_column(u'core_contentmodel', 'meta_description')

        # Deleting field 'ContentModel.meta_keywords'
        db.delete_column(u'core_contentmodel', 'meta_keywords')
