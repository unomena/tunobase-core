...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContentBlockSet'
        db.create_table(u'core_contentblockset', (
        ...
        db.send_create_signal(u'core', ['ContentBlockSet'])
    ...
    def backwards(self, orm):
        # Deleting model 'ContentBlockSet'
        db.delete_table(u'core_contentblockset')
