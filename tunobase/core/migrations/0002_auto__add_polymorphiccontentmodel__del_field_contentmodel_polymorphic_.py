...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PolymorphicContentModel'
        db.create_table(u'core_polymorphiccontentmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_core.polymorphiccontentmodel_set', null=True, to=orm['contenttypes.ContentType'])),
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='polymorphiccontentmodel_related', null=True, to=orm['photologue.PhotoEffect'])),
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='polymorphiccontentmodel_created_content', null=True, to=orm['authentication.EndUser'])),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='polymorphiccontentmodel_modified_content', null=True, to=orm['authentication.EndUser'])),
        ...
        db.send_create_signal(u'core', ['PolymorphicContentModel'])

        # Adding M2M table for field sites on 'PolymorphicContentModel'
        m2m_table_name = db.shorten_name(u'core_polymorphiccontentmodel_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('polymorphiccontentmodel', models.ForeignKey(orm[u'core.polymorphiccontentmodel'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['polymorphiccontentmodel_id', 'site_id'])

        # Deleting field 'ContentModel.polymorphic_ctype'
        db.delete_column(u'core_contentmodel', 'polymorphic_ctype_id')

        # Adding field 'ContentModel.leaf_content_type'
        db.add_column(u'core_contentmodel', 'leaf_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PolymorphicContentModel'
        db.delete_table(u'core_polymorphiccontentmodel')

        # Removing M2M table for field sites on 'PolymorphicContentModel'
        db.delete_table(db.shorten_name(u'core_polymorphiccontentmodel_sites'))

        # Adding field 'ContentModel.polymorphic_ctype'
        db.add_column(u'core_contentmodel', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_core.contentmodel_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Deleting field 'ContentModel.leaf_content_type'
        db.delete_column(u'core_contentmodel', 'leaf_content_type_id')
    ...
    models = {
        ...
        u'core.polymorphiccontentmodel': {
            'Meta': {'ordering': "['order', '-publish_at']", 'object_name': 'PolymorphicContentModel'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'polymorphiccontentmodel_created_content'", 'null': 'True', 'to': u"orm['authentication.EndUser']"}),
            'crop_from': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10', 'blank': 'True'}),
            'date_taken': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'polymorphiccontentmodel_related'", 'null': 'True', 'to': u"orm['photologue.PhotoEffect']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'image_name': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'polymorphiccontentmodel_modified_content'", 'null': 'True', 'to': u"orm['authentication.EndUser']"}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'plain_content': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'polymorphic_core.polymorphiccontentmodel_set'", 'null': 'True', 'to': u"orm['contenttypes.ContentType']"}),
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'retract_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'rich_content': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['sites.Site']", 'null': 'True', 'blank': 'True'}),
