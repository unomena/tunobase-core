...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field content_blocks on 'ContentBlockSet'
        db.delete_table(db.shorten_name(u'core_contentblockset_content_blocks'))

        # Adding field 'ContentBlock.content_block_parent'
        db.add_column(u'core_contentblock', 'content_block_parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='content_blocks', null=True, to=orm['core.ContentBlockSet']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding M2M table for field content_blocks on 'ContentBlockSet'
        m2m_table_name = db.shorten_name(u'core_contentblockset_content_blocks')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contentblockset', models.ForeignKey(orm[u'core.contentblockset'], null=False)),
            ('contentblock', models.ForeignKey(orm[u'core.contentblock'], null=False))
        ))
        db.create_unique(m2m_table_name, ['contentblockset_id', 'contentblock_id'])

        # Deleting field 'ContentBlock.content_block_parent'
        db.delete_column(u'core_contentblock', 'content_block_parent_id')
