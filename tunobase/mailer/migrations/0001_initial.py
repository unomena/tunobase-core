...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OutboundEmail'
        db.create_table(u'mailer_outboundemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='outbound_emails', null=True, to=orm['authentication.EndUser'])),
            ('to_addresses', self.gf('django.db.models.fields.TextField')()),
            ('bcc_addresses', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('message', self.gf('ckeditor.fields.RichTextField')()),
            ('sent_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
        ))
        db.send_create_signal(u'mailer', ['OutboundEmail'])


    def backwards(self, orm):
        # Deleting model 'OutboundEmail'
        db.delete_table(u'mailer_outboundemail')
